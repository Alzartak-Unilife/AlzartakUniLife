...
|전공|이름|역할|주요 업무|기술 스택|
|-------|-----|-----|-----|-----|
|컴퓨터공학전공|문정훈|팀장|웹 프론트엔드 개발|![Vanilla JS](https://img.shields.io/badge/Vanilla%20JS-F7DF1E?style=flat-square&logo=javascript&logoColor=black) ![TypeScript](https://img.shields.io/badge/TypeScript-007ACC?style=flat-square&logo=typescript&logoColor=white)|
...
|전공|이름|역할|주요 업무|기술 스택|
|-------|-----|-----|-----|-----|
|컴퓨터공학전공|문정훈|팀장|윈도우 응용프로그램 개발|![C++](https://img.shields.io/badge/C++/CLI-004482?style=flat-square&logo=cplusplus&logoColor=white) ![.NET Core](https://img.shields.io/badge/.NET%20Core-512BD4?style=flat-square&logo=.net&logoColor=white)|
